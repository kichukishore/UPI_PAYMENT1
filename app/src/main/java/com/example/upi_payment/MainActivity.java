...
public class MainActivity extends AppCompatActivity {
    ...
    {
        Toast.makeText(MainActivity.this,"COLLECT THE MONEY BY OFFLINE",Toast.LENGTH_SHORT).show();
        Toast.makeText(MainActivity.this,"THANK YOU ",Toast.LENGTH_SHORT).show();
    }
    public void can(View view)
    {
        Toast.makeText(MainActivity.this,"PAYMENT CANCEL",Toast.LENGTH_SHORT).show();
        Toast.makeText(MainActivity.this,"THANK YOU ",Toast.LENGTH_SHORT).show();
    }
